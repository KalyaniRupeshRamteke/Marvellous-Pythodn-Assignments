...
def copyFilesSpecficExt(dictName,destDir,extention):
...
def main():
    ...
    if(len(sys.argv) == 2):
        if((sys.argv[1] == "--h") or (sys.argv[1] == "--H")):
            print("This application is used to copy files in new directory of particular extention.")
            print("This is the file automation script")
        elif((sys.argv[1] == "--u") or (sys.argv[1] == "--U")):
            print("Used the given script as ")
            print("ScriptName.py sourceDirectory destDirectory extention")
        ...
        fileNameList = copyFilesSpecficExt(sourceDir,destDir,extention)
